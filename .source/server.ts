...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "components/meta.json": __fd_glob_1, }, {"index.mdx": __fd_glob_2, "components/button.mdx": __fd_glob_3, "components/index.mdx": __fd_glob_4, });