const InputGroupThumb = ({ className }: { className?: string }) => (
  ...
  >
    ...
    {/* Search icon on left */}
    <circle cx="94" cy="150" r="8" stroke="var(--color-gray-500)" strokeWidth="2.5" fill="none" />
    <path
      d="M100 156L106 162"
    ...
    <rect x="285" y="140" width="40" height="20" rx="4" fill="var(--color-gray-100)" stroke="var(--color-gray-300)" strokeWidth="1" />
    <text x="305" y="154" textAnchor="middle" fontSize="10" fontFamily="monospace" fill="var(--color-gray-500)">⌘K</text>
