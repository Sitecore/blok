  ...
  return (
    <div className="relative" dir="ltr">
      ...
      <div className={codeBlockVariants({ variant })} dir="ltr">
        {showLineNumbers && (
          <div className="flex flex-col items-center justify-start py-2 px-2 text-sm gap-y-1" dir="ltr">
        ...
        <pre className="flex-1 overflow-x-auto p-2" dir="ltr">
          <code className="relative bg-transparent font-mono text-sm leading-none whitespace-pre-wrap break-words" dir="ltr">
            {code}
          </code>
        </pre>
      </div>
