...
function ComboboxInput({
  ...
  return (
    <InputGroup
      className={cn(
        "w-fit min-w-[8rem] shadow-none bg-body-bg dark:bg-input/30 font-semibold text-neutral-fg data-[placeholder]:text-muted-foreground [&_svg:not([class*='text-'])]:text-muted-foreground",
    ...
    >
      ...
      <InputGroupAddon align="inline-end">
        ...
        {showClear && (
          <ComboboxClear disabled={disabled} aria-label="Clear selection" />
        )}
      </InputGroupAddon>
      {children}
    </InputGroup>
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "bg-primary-background text-foreground flex h-[calc(--spacing(5.5))] w-fit items-center justify-center gap-1 rounded-sm px-1.5 text-xs font-medium whitespace-nowrap has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0",
        className,
      )}
      {...props}
    >
