    ...
    sections: [
      ...
      { id: "usage", title: "Usage" },
      {
        ...
        children: [
          ...
          { id: "card-versions", title: "Large & Compact" },
          { id: "card-vertical", title: "Vertical Detail" },
          { id: "card-vertical-medium", title: "Vertical Medium" },
          { id: "card-vertical-small", title: "Vertical Small" },
          { id: "card-horizontal-detail", title: "Horizontal Detail" },
          { id: "card-horizontal-normal", title: "Horizontal Normal" },
          { id: "card-horizontal-small", title: "Horizontal Small" },
        ],
      },
    ],
  },
      ...
      { id: "usage", title: "Usage" },
      {
        ...
        children: [
          ...
          { id: "prompt-input-queued", title: "Queued" },
          {
            ...
            title: "Queued Vercel AI input",
          },
          { id: "prompt-input-questions", title: "Questions" },
          {
            id: "prompt-input-questions-vercel",
            title: "Questions Vercel AI input",
          },
        ],
      },
    ],
