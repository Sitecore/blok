...
import { DropdownMenu, DropdownMenuSeparator, DropdownMenuItem, DropdownMenuContent, DropdownMenuGroup, DropdownMenuTrigger, DropdownMenuLabel } from "@/components/ui/dropdown-menu";
import { Icon } from "@/lib/icon";
import { mdiCreditCardOutline, mdiCheck, mdiLogout, mdiStarOutline, mdiBellOutline } from "@mdi/js";

export function DropdownMenuAvatarOnly() {
    return (
      <DropdownMenu>
