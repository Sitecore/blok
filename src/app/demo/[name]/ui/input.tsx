  ...
  components: {
    ...
    Text: (
      <div className="grid gap-2 w-75 ml-2">
        ...
        <Input type="text" id="text-input" placeholder="Enter text" aria-invalid="true" autoComplete="off" />
      </div>
    ),
    Password: (
      <div className="grid gap-2 w-75 ml-2">
    ...
    Disabled: (
      <div className="grid gap-2 w-75 ml-2">
        ...
        <Input disabled id="disabled-input" placeholder="This input is disabled" autoComplete="off" />
      </div>
    ),
  },
};
