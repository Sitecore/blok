...
export default function NavigationMenuDemo() {
  return (
    <div className="pb-70 px-50">
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
            <NavigationMenuTrigger>Getting Started</NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul className="grid gap-2 w-full max-w-[500px] lg:grid-cols-[.75fr_1fr] lg:w-[600px]">
                <ListItem
                  href="#"
                ...
                <ListItem href="#" title="Build better products faster">
                  Blok is a Sitecore's product design system: the ui framework
                  and style guide we use to build great apps. It's publicly
                  available, so that anyone can easily build software in the
                  Sitecore product design language.
                </ListItem>
