...
const InstallationCode = `npx shadcn@latest add https://${process.env.VERCEL_REGISTRY_URL}/r/blok-components.json `;
    ...
    <main className="w-full">
      ...
      <div className="px-6">
        ...
        <div className="flex flex-col space-y-2 mt-4 p-5 md:mt-2 md:px-10">
          ...
          <Codeblocks 
            code={`npx shadcn@latest add https://${process.env.VERCEL_REGISTRY_URL}/r/button.json`}
            showLineNumbers={false} 
          />
          <Alert variant="primary" className="items-start mt-4">
            <AlertDescription className="flex flex-col gap-3">
              ...
              <Codeblocks 
                code={`npx shadcn@latest add https://${process.env.VERCEL_REGISTRY_URL}/r/blok-components.json`}
                showLineNumbers={false} 
              />
              <p className="pt-2">
