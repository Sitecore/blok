...
const MIGRATION_PATHS = [
  ...
  },
  {
    ...
    steps: ["Matching components", "Gaps requiring new component creation"],
  },
  {
...
const FAQ = [
  {
    ...
    answer:
      "Yes, but only short‑term. Chakra + Tailwind together increase complexity and risk inconsistencies.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. You fully own the component source, making long‑term extension easier.",
  },
  {
    question: "How do we get Blok components now?",
    answer:
      "All components are sourced via the Blok registry (JSON endpoints).",
  },
  {
    question: "Will the FAQ expand over time?",
    answer:
      "Yes. New questions will be added based on internal and external feedback, including teams who complete early migrations.",
  },
];
    ...
    <main className="w-full">
      <div className="px-4 sm:px-8 md:px-32 max-w-[1250px] mx-auto">
        <div className="flex flex-col space-y-5 p-5 md:p-10">
          ...
          <p className="d w-full ">
            ...
            of how to migrate from the legacy Chakra‑based Blok Design System to
            the new
            <span className="font-medium">
              {" "}
              Tailwind CSS + shadcn/ui–based Blok
            </span>
            . Because the underlying technologies, patterns, and component
            architecture have fundamentally changed, this document outlines
            everything teams need to understand before and during migration.
          </p>
          <p className="mt-2">
            This page is meant to serve as the authoritative migration reference
            for Sitecore teams, partners, and external developers.
          </p>
        </div>
      </div>
      ...
      <div className="px-4 sm:px-8 md:px-32 max-w-[1250px] mx-auto pb-16 md:pb-24">
        <div className="flex flex-col space-y-3 p-5 md:pt-10 md:px-10">
          ...
          <p>The new Blok introduces major foundational changes:</p>
          <ul className="list-disc list-inside space-y-2 ">
            <li>
              Chakra UI → shadcn/ui (source‑owned components instead of library
              abstraction)
            </li>
          ...
          <p className="mt-2">
            These changes impact how components are written, extended, themed,
        ...
        <div className="flex flex-col space-y-3 p-5 md:pt-10 md:px-10">
          ...
          <p>A successful migration requires work in several areas:</p>
