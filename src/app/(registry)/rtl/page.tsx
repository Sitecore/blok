        ...
        <div className="flex flex-col space-y-5 p-5 md:p-10">
          ...
          <Alert variant="primary">
            <AlertDescription className="inline">
              ...
              </Link> to enable automatic RTL support.
            </AlertDescription>
          </Alert>
        </div>
      </div>
      ...
      <div className="px-32">
        <div className="flex flex-col space-y-3 p-5 md:pt-2 md:px-10">
          ...
          <div className="mt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {RTL_LANGUAGES.map((lang) => (
                ...
                >
                  <div className="font-mono text-sm text-muted-foreground">{lang.code}</div>
          ...
          <p className="mt-4 text-muted-foreground">
            <strong>Note:</strong> Any language not in this list defaults to LTR (Left-to-Right).
          </p>
        </div>
        ...
        <div className="flex flex-col space-y-3 p-5 md:pt-2 md:px-10">
          ...
          <p>
            The <code className="inline text-sm tabular-nums bg-muted px-1 rounded">DirectionProvider</code> wraps your app to provide global reading direction. It enables all Radix UI primitives to inherit the global reading direction.
          </p>
        ...
        <div className="flex flex-col space-y-3 p-5 md:pt-2 md:px-10">
          ...
          <p>
            To implement RTL support in your application, wrap your app with the <code className="inline text-sm tabular-nums bg-muted px-1 rounded">DirectionProvider</code> component:
          </p>
          <Codeblocks 
          ...
          />
          <p className="mt-4">
            The provider automatically detects the browser language and sets the appropriate direction. You can also use the <code className="inline text-sm tabular-nums bg-muted px-1 rounded">useDirection()</code> hook in your components to access the current direction:
          </p>
          <Codeblocks 
            showLineNumbers={true} 
        ...
        <div className="flex flex-col space-y-3 p-5 md:pt-2 md:px-10">
          ...
          <ol className="list-decimal list-inside space-y-3 text-muted-foreground">
            <li>
              <strong>Install the dependency</strong> (see Installation section above)
            </li>
            <li>
              <strong>Create direction utilities</strong> (optional, for automatic detection):
              <p className="mt-2">
                Create a utility file to detect RTL languages and get browser language. See <code className="inline text-sm tabular-nums bg-muted px-1 rounded">src/lib/direction-utils.ts</code> for reference.
              </p>
            </li>
            <li>
              <strong>Wrap your app with DirectionProvider</strong>:
              <p className="mt-2">
                In your root layout, wrap your application with the DirectionProvider component (see Implementation section above).
              </p>
            </li>
            <li>
              <strong>Use the useDirection hook</strong>:
              <p className="mt-2">
                In components that need to adapt to RTL, use the <code className="inline text-sm tabular-nums bg-muted px-1 rounded">useDirection()</code> hook from <code className="inline text-sm tabular-nums bg-muted px-1 rounded">@radix-ui/react-direction</code> (see Examples section below).
              </p>
            </li>
          </ol>
        </div>
  ...
  return (
    <RadixDirectionProvider dir="rtl">
      {/* Your app content */}
            ...
            <div className="mb-20">
              <h3 className="font-semibold text-xl mb-2">Using the Hook in Components</h3>
              <Codeblocks 
                showLineNumbers={true} 
