    ...
    <main className="w-full">
      <div className="px-4 sm:px-8 md:px-32 max-w-[1250px] mx-auto">
        <div className="flex flex-col space-y-5 p-5 md:p-10">
          ...
          <p className="d w-full ">
            ...
            to external data sources and tools. With the shadcn MCP server, your
            AI assistant can:
          </p>
          <ul className="list-disc list-inside space-y-2 ">
            ...
            <li>
              Access Blok components using the{" "}
          ...
          <p className="mt-2">
            ...
            <em>
              "build a landing page using components from the Blok registry."
            </em>
          </p>
          <Alert variant="primary">
            <AlertDescription className="inline text-lg">
              ...
              <Link
                ...
                target="_blank"
                className="text-primary hover:text-primary/80 hover:underline"
                rel="noopener noreferrer text-primary-fg font-semibold"
              >
      ...
      <div className="px-4 sm:px-8 md:px-32 max-w-[1250px] mx-auto">
        <div className="flex flex-col space-y-3 p-5 md:pt-10 md:px-10">
          ...
          <p>
            Before you initialize an MCP client or try prompts that reference
            the Blok registry, add the Blok registry to your project so{" "}
            <code className="inline text-sm tabular-nums bg-muted px-1 rounded">
              @blok/*
            </code>{" "}
        ...
        <div className="flex flex-col space-y-3 p-5 md:pt-10 md:px-10">
          <h2 className="font-semibold text-3xl  md:text-4xl">Quick Start</h2>
          <p>
            Select your MCP client and follow the instructions to configure the
            shadcn MCP server. If you'd like to do it manually, see the{" "}
            <Link
              href="#configuration"
              className="text-primary hover:text-primary/80 hover:underline"
            >
          ...
          <Tabs defaultValue="claude">
            <TabsList className="flex flex-wrap">
              <TabsTrigger
                value="claude"
                className="whitespace-normal text-center px-3 py-2"
              >
                Claude Code
              </TabsTrigger>
              <TabsTrigger
            ...
            <TabsContent value="claude" className="space-y-2">
              <p>
                To initialize an MCP project for Claude using the shadCN CLI,
              ...
              <p className="mt-2">
                You can then test that your installation has been successful by
                trying prompts, for example:
              </p>
              <ul className="list-disc list-inside space-y-2">
                <li>
                ...
                <li>
                  Create a contact form using components from the shadcn
                  registry.
                </li>
              </ul>
            ...
            <TabsContent value="cursor" className="space-y-2">
              <p>
                To initialize an MCP project for Cursor using the shadCN CLI,
                run the following command:
              </p>
              <Codeblocks
                showLineNumbers={false}
            ...
            <TabsContent value="vscode" className="space-y-2">
              <p>
                To initialize an MCP project for VS Code using the shadCN CLI,
                run the following command:
              </p>
              <Codeblocks
                showLineNumbers={false}
            ...
            <TabsContent value="codex" className="space-y-2">
              <p>
                To initialize an MCP project for Codex using the shadCN CLI, run
...
args = ["shadcn@latest", "mcp"]`}
              ...
              <Alert variant="primary" className="mt-4">
                <AlertDescription className="inline">
                  ...
                  CLI cannot automatically update{" "}
                  <code className="inline text-sm tabular-nums bg-muted px-1 rounded">
                    ~/.codex/config.toml
                  </code>
        ...
        <div className="flex flex-col space-y-3 p-5 md:pt-10 md:px-10">
          <h2 id="configuration" className="font-semibold text-3xl md:text-4xl">
          ...
          <p className="mt-2">
            After adding the configuration, enable the shadcn MCP server in
            Cursor Settings.
          </p>
          <p className="mt-2">
            Once enabled, you should see a green dot next to the shadcn server
            in the MCP server list and a list of available tools.
          </p>
          <p className="mt-2">
            See the{" "}
            <Link
              href="https://docs.cursor.com/en/context/mcp#using-mcp-json"
              target="_blank"
              className="text-primary hover:text-primary/80 hover:underline"
              rel="noopener noreferrer"
            >
        ...
        <div className="flex flex-col space-y-3 p-5 md:pt-10 md:px-10">
          ...
          <p>
            Once the MCP server is configured, you can interact with the Blok
            registry with natural language, for example:
          </p>
        ...
        <div className="flex flex-col space-y-3 mb-10 p-5 md:pt-10 md:px-10 md:pb-10">
          ...
          <ol className="list-decimal list-inside space-y-2 ">
            <li>
              Verify the MCP server is properly configured and enabled in Cursor
              Settings.
            </li>
            <li>Restart Cursor after configuration changes.</li>
            <li>
              In Cursor, view logs by clicking View, then click Output, and
              select{" "}
              <code className="inline text-sm tabular-nums bg-muted px-1 rounded">
                MCP: project-*
              </code>{" "}
          ...
          <ol className="list-decimal list-inside space-y-2 ">
            ...
            <li>
              Ensure environment variables are set if using private registry
            </li>
            <li>Confirm the Blok registry is online and accessible</li>
            <li>
              Ensure namespace syntax is correct (
              <code className="inline text-sm tabular-nums bg-muted px-1 rounded">
                @blok/component-name
              </code>
              )
