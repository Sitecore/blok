...
export const Snippet = ({ className, ...props }: SnippetProps) => (
  <Tabs
    className={cn(
      'group w-full gap-0 overflow-hidden rounded-lg bg-background',
      className
    )}
    {...props}
  />
...
export const SnippetHeader = ({ className, ...props }: SnippetHeaderProps) => (
  <div
    className={cn(
      'flex flex-row items-center justify-between bg-background p-2',
      className
    )}
    {...props}
  />
...
export const SnippetTabsTrigger = ({
  ...
  <TabsTrigger className={cn(
    'gap-1.5 text-base rounded-md px-3 py-1 transition-colors border-none',
...
export const SnippetTabsContent = ({
  ...
  <TabsContent
    asChild
    className={cn('mt-0 bg-background p-4 pt-2 text-base text-foreground', className)}
    {...props}
  >
