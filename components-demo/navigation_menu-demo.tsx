...
const components: { title: string; href: string; description: string }[] = [
  ...
  export function NavigationMenuDemo() {
    return (
      <div>
        <h2 className="font-semibold text-4xl wrap-break-words">Navigation Menu</h2>
      <div className="flex w-full max-w-full gap-4">
        <div id="navigation-menu-default">
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <ul className="grid gap-2 w-full max-w-[500px] lg:grid-cols-[.75fr_1fr]">
                    ...
                    <ListItem href="#" title="Build better products faster">
                      Blok is a Sitecore's product design system: the ui framework and
                      style guide we use to build great apps. It's publicly available,
                      so that anyone can easily build software in the Sitecore product
                      design language.
                    </ListItem>
