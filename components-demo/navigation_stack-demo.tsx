...
import {
  ...
  mdiHistory, mdiLayers, mdiViewDashboard
} from "@mdi/js";
...
export function NavigationStackDemo  (){
  ...
  return (
    <div>
      <h2 className="font-semibold text-4xl wrap-break-words">Navigation (Stack)</h2>
    ...
    <br />
        <div id="stack-navigation-horizontal-tabs">
          <div className="w-full bg-background overflow-hidden">
            <StackNavigation
              items={navigationItemsTabs} //Changed navigationItems to navigationItemsTabs
              orientation="horizontal"
    ...
    <br />
        <div id="stack-navigation-color-schemes">
