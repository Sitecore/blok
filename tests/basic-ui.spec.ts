...
import { testCombobxAutoHighlight, testCombobxClearButton, testCombobxCustomItems, testCombobxGroups, testCombobxInputGroup, testCombobxMultiple, testCombobxWithDescription } from './test-Components/test-Combobox';
...
import { testToggleGroupRounded, testToggleGroupSquare, testToggleGroupSizes } from './test-Components/test-Toggle_group';
...
test.describe('UI BLOK QA Automation', () => {
  ...
  test('test_Combobox', async ({ page }) => {
    ...
    await testCombobxWithDescription(page);
  });
  ...
  test('test_Field', async ({ page }) => {
    ...
    await testFieldTextarea(page);
    await testFieldSelect(page);
    await testFieldCheckbox(page);
    await testFieldRadioGroup(page);
    await testFieldSwitch(page);
    await testFieldSeparator(page);
    await testFieldError(page);
    await testFieldIcon(page);
    await testFieldAddon(page);
    await testFieldDisabled(page);
    await testFieldReadOnly(page);
  ...
  test('test_Toggle_group', async ({ page }) => {
    ...
    await testToggleGroupSizes(page);
  });
